export const IDENTITY_CONFIG = {
    ...
    response_type: "code",
    scope: "openid profile vipsearchapi vipmenuapi", //(string, default: 'openid'): The scope being requested from the OIDC provider.
};
...
//     //grantType: "code",
//     response_type: "code",
//     scope: "openid profile vipsearchapi", //(string, default: 'openid'): The scope being requested from the OIDC provider.
//     //webAuthResponseType: "id_token token",
//     filterProtocalClaims: true
// };
